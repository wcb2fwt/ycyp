...
import com.bonzd.dicom.util.DicomEntityBuilder;
...
public class DBServiceImpl implements DBService {
    ...
    public Patient buildPatient(DicomReader reader) {
        ...
        if(patient == null){//let's create new patient
            patient = DicomEntityBuilder.newPatient(reader.getPatientAge(), reader.getPatientBirthDay(), reader.getPatientID(), reader.getPatientName(), reader.getPatientSex(), reader.getDeviceSerialNumber());
            patientDao.save(patient);
    ...
    private void printStats(String status) {
